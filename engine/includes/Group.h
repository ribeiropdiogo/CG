...
private:
    ...
    void popDraw(int idx, GLuint * vaos, GLuint * textures,GLuint * materials, vector<Shader> progs);
public:
    Group();
    ...
    int publish(GLuint * vaos, GLuint * textures, GLuint * materials, vector<Shader> progs, int milis);
    void drawTracing();
    int addSubgroup();
